<template>
  <div class="page_index">
    ...
    <div class="footer_items">
      <div class="lists">
        <template v-for="(item, index) in listNFTData"
                  :key="index">
          <div class="items"
            ...
            <div class="items_content">
              ...
              <div class="list">
                <label v-for="(desc, descIndex) in item.desc"
                       @click.stop="detailInfo(index, descIndex)"
                       :key="descIndex">
                  {{ desc }}
                </label>
              </div>
...
function detailInfo (index, descIndex) {
  ...
  if (index === 0) {
    ...
    if (descIndex !== undefined) posIndex = [0, 1, 2, 6, 8][descIndex]
